...
namespace Shoope.Application.ServicesTests.AddressServiceTest
{
    public class AddressServiceTest
    {
        ...
        public async Task Should_UpdateAddressUser_Success()
        {
            ...
            _addressServiceConfiguration.AddressRepositoryMock.Setup(rep => rep.UpdateUser(It.IsAny<Address>()))
                .ReturnsAsync(new Address());
        ...
        public async Task Should_Delete_Success()
        {
            ...
            _addressServiceConfiguration.AddressRepositoryMock.Setup(rep => rep.Delete(It.IsAny<Address>()))
                .ReturnsAsync(new Address());
