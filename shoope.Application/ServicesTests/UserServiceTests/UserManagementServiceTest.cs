    ...
    public class UserManagementServiceTest
    {
        ...
        public UserManagementServiceTest()
        {
            ...
            var userManagementService = new UserManagementService(_userManagementServiceConfiguration.UserRepositoryMock.Object,
                ...
                _userManagementServiceConfiguration.UserCreateAccountFunctionMock.Object);
        ...
        public async Task Should_UpdateUserAll_Success()
        {
            ...
            _userManagementServiceConfiguration.UserRepositoryMock.Setup(rep => rep.UpdateUser(It.IsAny<User>()))
                .ReturnsAsync(new User());
