...
{
    public class PromotionUserRepository : IPromotionUserRepository
    {
        private readonly ApplicationDbContext _context;

        public PromotionUserRepository(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<PromotionUser> Create(PromotionUser promotionUser)
        {
            await _context.PromotionUser.AddAsync(promotionUser);
            await _context.SaveChangesAsync();

            return promotionUser;
        }

        public async Task<PromotionUser> Delete(PromotionUser promotionUser)
        {
            _context.PromotionUser.Remove(promotionUser);
            await _context.SaveChangesAsync();
